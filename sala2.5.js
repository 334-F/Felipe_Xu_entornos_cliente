...
function iniciarSala2() {
    try {
        ...
        // ----------------------------------------------------
        // BLOQUE 5: EVENTOS DOM Y CONTROL DE ERRORES
        // ----------------------------------------------------
        document.getElementById('btnComprobar').addEventListener('click', function () {
            ...
            // Comprobamos si coincide con la solución calculada
            if (input === codigoFinal) {
                log("<br><span style='color:blue'>¡Fórmula Correcta! Has escapado.</span>");
            } else {
                log("<br><span style='color:red'>Mezcla inestable. Intenta de nuevo.</span>");
            }
        });
